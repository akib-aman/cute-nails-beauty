    ...
    return (
        <section className="bg-gray-50 py-16" id="contact-section">
            <div className="container mx-auto px-4 lg:max-w-screen-xl md:max-w-screen-md">
                ...
                {/* Map */}
                <div className="w-full max-w-2xl h-[32rem] mx-auto mb-12 rounded-lg overflow-hidden shadow-md">
                    <iframe
                ...
                <div className="text-center">
                    ...
                    {/* Placeholder: Replace with live data if needed via backend or API */}
