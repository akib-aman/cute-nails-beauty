            ...
            <div className="text-center">
              ...
              <ul className="flex items-center justify-center gap-[10px]">
                <li>
                  <Link
                    href="/"
                    className="text-black flex items-center gap-[10px] text-base font-medium text-white text-opacity-50"
                  >
                    Home
                  </Link>
                </li>
                <li>
                  <p className="text-body-color flex items-center gap-[10px] text-base font-medium">
                    <span className="text-body-color text-white text-opacity-50"> / </span>
                    {pageName}
                  </p>
                </li>
              </ul>
